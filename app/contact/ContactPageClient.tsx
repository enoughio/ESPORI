...
function ContactPageClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Sending email to aj@gmail.com with form data:", formState)
                  ...
                  <Card className="border-none glass-card hover:shadow-lg transition-all duration-300">
                    <CardContent className="p-6 flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="mailto: aniketj.developer@gmail.com" className="text-primary hover:underline">
                          aniketj.developer@gmail.com
                        </a>
