        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Explore our portfolio of successful projects and see how we've helped our clients achieve their goals in
              Bhopal and beyond.
            </p>
              ...
              <Button
                ...
                className={`group ${
                  activeCategory === category.id
                    ? "bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white border-0 relative overflow-hidden"
                    : "border-primary/50 hover:border-primary text-primary hover:text-primary relative overflow-hidden"
                }`}
              >
